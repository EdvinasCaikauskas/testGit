...
const Arena = ({getPlayer, weapon, setView, setMoney, money, potionState}) => {
   ...
   if(potionState.effect.health === 0 && potion) {
    ...
    function hit() {
        ...
        const playerDamage = random(weapon.maxDamage) + getPlayer.damage
        ...
        const damageMateToPlayerInPercent = getPercent(getPlayer.health, enemyDamage)

        setPlayerHealth(getPlayerHealth - damageMateToPlayerInPercent)
    ...
    return (
        <div className='d-flex space-around'>
            <div>
                <img className="player-arena" src={getPlayer.image} alt=""/>
            ...
            <div>
                <img src={monsters[getMonster].image}
                     alt=""/>
                <div className='progress-wrapper'>
